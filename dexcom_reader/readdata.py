...
class Dexcom(object):
  ...
  def ParsePage(self, header, data):
    ...
    elif (record_type == int) and (record_type > 14):  # can't parse records so just print raw data
      return header, data
    else:
